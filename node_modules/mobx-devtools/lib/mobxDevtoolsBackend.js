(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["mobxDevtoolsBackend"] = factory();
	else
		root["mobxDevtoolsBackend"] = factory();
...
function serialize(data) {
  ...
  try {
    ...
    if (prototype && prototype !== Object.prototype) {
      var _symbols$proto, _result3;

      // This is complex object (dom node or mobx.something)
      // only short signature will be sent to prevent performance loss
      var _result2 = (_result3 = {}, (0, _defineProperty3.default)(_result3, symbols.type, 'object'), (0, _defineProperty3.default)(_result3, symbols.name, data.constructor && data.constructor.name), (0, _defineProperty3.default)(_result3, symbols.inspected, inspecting), (0, _defineProperty3.default)(_result3, symbols.editable, true), (0, _defineProperty3.default)(_result3, symbols.mobxObject, '$mobx' in data), (0, _defineProperty3.default)(_result3, symbols.proto, (_symbols$proto = {}, (0, _defineProperty3.default)(_symbols$proto, symbols.type, 'object'), (0, _defineProperty3.default)(_symbols$proto, symbols.name, prototype.constructor && prototype.constructor.name), (0, _defineProperty3.default)(_symbols$proto, symbols.inspected, false), (0, _defineProperty3.default)(_symbols$proto, symbols.editable, false), _symbols$proto)), _result3);
      if (inspecting) {
        for (var p in data) {
          if (Object.prototype.hasOwnProperty.call(data, p)) {
            _result2[p] = serialize(data, path.concat(p), seen, p);
          }
        }
      }
      return _result2;
...
var _weakMap = __webpack_require__(72);
...
var _Bridge = __webpack_require__(27);
...
var _backend = __webpack_require__(90);
...
var _debugConnection = __webpack_require__(160);

var _debugConnection2 = _interopRequireDefault(_debugConnection);

var _installGlobalHook = __webpack_require__(161);

var _installGlobalHook2 = _interopRequireDefault(_installGlobalHook);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _installGlobalHook2.default)(window);
var hook = window.__MOBX_DEVTOOLS_GLOBAL_HOOK__; // eslint-disable-line no-underscore-dangle

var connectToDevTools = function connectToDevTools(options) {
  var _options$host = options.host,
      host = _options$host === undefined ? 'localhost' : _options$host,
      _options$port = options.port,
      port = _options$port === undefined ? 8098 : _options$port;
...
var _getId = __webpack_require__(71);
...
var _getDependencyTree = __webpack_require__(124);

var _getDependencyTree2 = _interopRequireDefault(_getDependencyTree);

var _highlight = __webpack_require__(59);

var _domNodePicker = __webpack_require__(147);

var _domNodePicker2 = _interopRequireDefault(_domNodePicker);

var _inspector = __webpack_require__(82);

var _inspector2 = _interopRequireDefault(_inspector);

var _storaTempValueInGlobalScope = __webpack_require__(87);
...
var _changesProcessor = __webpack_require__(158);

var _changesProcessor2 = _interopRequireDefault(_changesProcessor);

var _consoleLogChange = __webpack_require__(159);
