...
export default class RestaurantPage extends Component{
  ...
  render(){
    ...
    const DataToShow = this.state.restaurants  !== null ? () => <GridList data={ this.state.restaurants } GridListItem = {RestListItem}/>
        ...
        <div className='rest-page-content'>
          <div className="filter-bar">
            <div className="search-bar">
              <SearchPanel onSearchChange = {this.onSearchChange} placeholder="Search restaurants"/>
            </div>
