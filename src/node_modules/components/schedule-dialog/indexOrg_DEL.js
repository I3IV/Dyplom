...
export default class ScheduleDialog extends React.Component {
  ...
  onDishChange = ({name, value}) => {
    this.setState({
        selectedDish: {name: dishIdToName(value), id: value, products: productsSelectItems(value) },
    });
  };
  onDishAdd = () => {
...
console.log("rendering... State=", this.state);
    ...
    const DishProducts =  this.state.selectedDish ? () => ( <ProductsList items={this.state.selectedDish.products} /> )
                                                  : () => ( <span></span> );
    return (
      <div >
        <Dialog
