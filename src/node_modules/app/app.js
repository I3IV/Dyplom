...
import ManagerRegistration from "../components-illia/pages/registration-page-manager";
import LoginPage from "../components-illia/pages/login-page";
import ManagerSignIn from "../components-illia/pages/login-page-manager";
      ...
      <Router>
        <Fragment>
          ...
          <MuiThemeProvider theme={muiTheme}>
            ...
            <Route path="/for-business/registration" component={ManagerRegistration} />
            <Route path="/for-business/sign-in" component={ManagerSignIn} />
